      ...
      <div className="max-w-7xl mx-auto " >
        ...
        <form onSubmit={handleSubmit} className="flex flex-col items-center gap-4 mr-5 ml-5">
          <input
            ...
            className="w-full max-w-md p-2 m-2 border shadow-md bg-[#FAF8F6]  rounded-md text-black"
            required
          />
          <input
            type="email"
            ...
            className="w-full max-w-md p-2 m-2 border shadow-md rounded-md bg-[#FAF8F6]  text-black"
            required
          />
          <textarea
